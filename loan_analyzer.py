...
print(f"The total of all the loans calculate to:{total_loans}")
# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan = total_loans / number_of_loans
print(f"After calculations the average loan from the list came out to:{average_loan}")
...
if present_value >= future_value:
    print(f"The loan is worth the buy.")
else:
...
present_value = add(new_loan["future_value"], new_loan["remaining_months"],annual_discount_rate)
...
for element in loans:
    if element["loan_price"] <= 500:
        inexpensive_loans.append(element)
